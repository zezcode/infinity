...
<html lang="vi">
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<style>body { background-image: url('/theme/infinity/media/auth/bg5.jpg'); } [data-bs-theme="dark"] body { background-image: url('/theme/infinity/media/auth/bg5-dark.jpg'); }</style>
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<div class="mb-0">
								...
								<img src="/theme/infinity/media/auth/please-verify-your-email-dark.png" class="mw-100 mh-300px theme-dark-show" alt="" />
							</div>
						</div>
					</div>
				</div>
