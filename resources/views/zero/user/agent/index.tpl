								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div class="menu-item menu-accordion">
										...
										<a class="menu-link" href="user/profile">
											...
											<span class="menu-title">user center</span>
										</a>
									</div>
                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
												...
												<div class="card-body d-flex flex-column flex-center">
													...
													<div class="mb-2">
														...
														<div class="py-10 text-center">
															<img src="/theme/infinity/media/svg/illustrations/easy/4.svg" class="w-200px" alt="" />
														</div>
														<!--end::Illustration-->
													</div>
													<!--end::Heading-->
								...
								{else}
									<div class="card flush">
										<div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%;background-image:url('/theme/infinity/media/stock/900x600/42.png');">
											<div class="mb-10">
											...
											<img class="mx-auto h-250px h-lg-400px theme-light-show" src="/theme/infinity/media/illustrations/misc/upgrade.svg" alt>
											<img class="mx-auto h-250px h-lg-400px theme-dark-show" src="/theme/infinity/media/illustrations/misc/upgrade-dark.svg" alt>
										</div>
									</div>
								{/if}	
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">user.billing.withdraw_setting</h4>
            </div>
            <div class="modal-body">
                <p class="text-warning">user.billing.withdraw_alert</p>
                <form>
					<div class="mb-3">
						<label class="col-form-label fw-bold" for="recipient-name">user.billing.withdraw_account_type:</label>
                ...
                <form>
					<div class="mb-3">
						<label class="col-form-label fw-bold" for="recipient-name">user.billing.withdraw_account:</label>						
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="withdrawaccount()">submit</button>
...
<div class="modal fade" id="zero_agent_withdraw_modal" data-bs-backdrop="static" tabindex="-1" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">user.billing.withdraw_confirm</h4>
            </div>
            <div class="modal-body">
				<label class="col-form-label fw-bold" for="recipient-name">提现金额:</label>
                <form class="mb-3">
                    <input type="number" class="form-control" placeholder="user.billing.withdraw_amount" id="commission_amount"/>
                </form>
                ...
                <ul class="nav nav-pills row nav-primary mb-3" role="tablist">
                    <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0" id="taketype">
                        <a class="btn btn-outline btn-outline-dashed btn-active-light-primary text-start d-flex flex-grow-1 flex-column align-items-center active" data-bs-toggle="pill" data-type="1">
                            ...
                            <span class="nav-text fs-6 py-2 text-center">user.billing.withdraw_to_balance<br/>
                            <small>user.billing.less_than: 0</small></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0" id="taketype">
                        <a class="btn btn-outline btn-outline-dashed btn-active-light-primary text-start d-flex flex-grow-1 flex-column align-items-center" data-bs-toggle="pill" data-type="2">
                            ...
                            <span class="nav-text fs-6 py-2 text-center">user.billing.withdraw_to_usdt<br />
                            <small>user.billing.less_than: {$config['withdraw_minimum_amount']}</small></span>
                        </a>
                    </li>
                    {/if}
                </ul>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" type="button" onclick="withdraw()">submit</button>
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Hủy</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="zero_agent_add_credit_modal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLongTitle">user.billing.add_credit</h4>
            </div>
            <div class="modal-body">
				<label class="col-form-label fw-bold" for="recipient-name">充值金额:</label>		
				<div class="form-group">
					<div class="input-group">
						<input type="text" class="form-control" placeholder="user.billing.add_amount" id="add_credit_amount">
					</div>
				</div>
            </div>
            <div class="modal-footer">
                <a type="button" class="btn btn-primary" onclick="KTUsersCreateOrder('add_credit_order')">submit</a>
                <a type="button" class="btn btn-light" data-bs-dismiss="modal">Hủy</a>
            </div>
        </div>
    </div>
</div>
