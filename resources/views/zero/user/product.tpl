																			...
																			<div class="d-flex h-100 align-items-center">
																				<div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">                                                      
																					...
																					{if is_null($product->custom_content)}
																							...
																							{else}
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3"><span class="badge badge-success fw-bold fs-6">{$product->traffic}GB</span> Lưu lượng</span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3"><span class="badge badge-success fw-bold fs-6">{if empty($product->ip_limit)}unlimited{else}{$product->ip_limit}{/if}&nbsp;online ip</span></span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3">{if empty($product->speed_limit)}<span class="badge badge-success fw-bold fs-6">unlimited</span>{else}{$product->speed_limit} Mbps{/if}&nbsp;bandwidth</span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3">no rule</span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3"><span class="badge badge-success fw-bold fs-6">{$user->getPermission($product->class)}&nbsp;access permission</span></span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1">only owner use</span>
																					...
																					{if $product->stock > 0 && $product->stock - $product->realTimeSales() <= 0}
																						<button class="btn btn-sm fw-bold btn-primary" disabled>sold</button>
																					{else}
																						<button class="btn btn-sm fw-bold btn-primary" type="submit" data-kt-users-action="check-out-{$product->id}" data-bs-toggle="modal" onclick="kTUserConfigureProductModal({$product->id})">
																							<span class="indicator-label">purchase</span>			
			...
			<div class="modal-dialog modal-xl modal-dialog-centered">
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						<div class="mb-13 text-center">
							<h1 class="mb-3">configure product</h1>
						</div>
						<div class="d-flex flex-column">
								...
								<div class="col-lg-7">
									<div class="tab-content rounded h-100 bg-light p-10">
										<div class="tab-pane fade show active">
											<div class="pb-5">
												<h2 class="fw-bold text-dark">what the product contains</h2>
								...
								<div class="col-lg-5">
									<div class="card card-dashed mb-5" id="zero_modal_configure_coupon_html">
										<div class="card-body">
											<div class="d-flex align-items-center">
												<input class="form-control me-3" placeholder=promo code type="text" id="zero_coupon_code">
									...
									<div class="card card-dashed card-flush mb-5">
										<div class="card-body">
											...
											<div class="d-flex align-items-center">
												<span class="fw-semibold fs-4 flex-grow-1 pe-3">total</span>
