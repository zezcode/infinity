																			...
																			<div class="d-flex h-100 align-items-center">
																				<div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">                                                      
																					<div class="mb-7 text-center">
																						...
																						<div class="text-center">
																							...
																							<span class="fs-3x fw-bold text-primary" id="zero_product_price_{$product->id}">
																								{if $product->type == 1}{$product->getAverageMonthlyPrice()}{else}{number_format($product->onetime_price, 0, '.', '')}{/if}
																							</span>
																							{if $product->type == 1}
																					...
																					{if is_null($product->custom_content)}
																							{if $product->type == 2}
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3">Lưu lượng:</span> <span class="badge badge-success fw-bold fs-6">{$product->traffic}GB</span>
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1">Mua thêm lưu lượng cho gói hiện tại</span>
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1">Chỉ mua nếu đã có gói sẵn</span>
																									<span class="svg-icon svg-icon-1 svg-icon-warning">
																									<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.9626 4.00678C12.231 3.99278 12.4815 4.13007 12.6157 4.36567C12.6163 4.36567 12.6168 4.36567 12.6174 4.36567L20.9173 18.9131C21.2029 19.4142 20.8717 19.9932 20.2999 19.9932H3.7002C3.12849 19.9932 2.79723 19.4142 3.08287 18.9131L11.3827 4.36567C11.3833 4.36567 11.3838 4.36567 11.3844 4.36567C11.5052 4.15367 11.721 4.01968 11.9626 4.00678H11.9626Z" stroke="#ffc700" stroke-linecap="square" stroke-linejoin="round" stroke-width="2"/><path d="M12 18C12.5523 18 13 17.5523 13 17C13 16.4477 12.5523 16 12 16C11.4477 16 11 16.4477 11 17C11 17.5523 11.4477 18 12 18Z" fill="#ffc700"/><path d="M12 15V8" stroke="#ffc700" stroke-width="2"/></svg>
																									</span>
																								</div>
																							{else}
																								<div class="d-flex align-items-center mb-5">
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3">Giới hạn thiết bị</span><span class="badge badge-success fw-bold fs-6">{if empty($product->ip_limit)}Không giới hạn{else}{$product->ip_limit}&nbsp;Thiết bị{/if}</span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3">Tốc độ tối đa: </span>{if empty($product->speed_limit)}<span class="badge badge-success fw-bold fs-6">Không giới hạn</span>{else}{$product->speed_limit} Mbps{/if}&nbsp;</span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																								<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3">Quy tắc hạn chế:</span><span class="badge badge-success fw-bold fs-6">Không&nbsp;</span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3">Quyền truy cập:</span><span class="badge badge-success fw-bold fs-6">{$user->getPermission($product->class)}&nbsp;</span>
																									<span class="svg-icon svg-icon-1 svg-icon-success">
																										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																											<rect opacity="0.3" x="2" y="2" width="20" height="20" rx="10" fill="currentColor" />
																											<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z" fill="currentColor" />
																								...
																								<div class="d-flex align-items-center mb-5">
																									<span class="fw-semibold fs-6 text-gray-800 flex-grow-1">Có thể sử dụng máy chủ ≤ {$user->getPermission($product->class)}</span>
																									<span class="svg-icon svg-icon-1 svg-icon-warning">
																										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
																											<path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
																										</svg>
																					...
																					{if $product->stock > 0 && $product->stock - $product->realTimeSales() <= 0}
																						<button class="btn btn-sm fw-bold btn-primary" disabled>Đã hết hàng</button>
																					{else}
									...
									<div class="card card-dashed mb-5" id="zero_modal_configure_coupon_html">
										<div class="card-body">
											<div class="d-flex align-items-center">
												<input class="form-control me-3" placeholder="Mã giảm giá" type="text" id="zero_coupon_code">
