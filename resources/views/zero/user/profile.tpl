    ...
    {include file ='include/index/menu.tpl'}
                                            ...
                                            <div class="card mb-5 mb-xl-8">
                                                <div class="card-body">
                                                    ...
                                                    <div id="kt_user_view_details" class="collapse show" style>
                                                        <div class="pb-5 fs-6">
                                                            <div class="fw-bolder mt-5">users ID</div>
                                                            <div class="text-gray-600">ID-{$user->id}</div>
                                                            <div class="fw-bolder mt-5">email</div>
                                                            <div class="text-gray-600">
                                                                <a class="text-gray-600 text-hover-primary">{$user->email}</a>
                                                            </div>
                                                            <div class="fw-bolder mt-5">last signin date</div>
                                            ...
                                            <div class="card mb-5 mb-xl-8">
                                                <div class="card-header border-0">
                                                    <div class="card-title">
                                                        <h3 class="fw-bolder m-0">notification</h3>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    <div class="fs-6 fw-semibold text-muted">email notification</div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    <div class="fs-6 fw-semibold text-muted">telegram notification</div>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex justify-content-end">
                                                                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                                                        ...
                                                        <div class="card-toolbar">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                                                <div class="menu-item px-3">
                                                                    <div class="menu-content fs-6 text-dark fw-bolder px-3 py-4">action</div>
                                                                </div>
                                                                <div class="separator mb-3 opacity-75"></div>
                                                                <div class="menu-item px-3">
                                                                    <a data-bs-toggle="modal" type="button" data-bs-target="#zero_user_add_credit_modal" class="menu-link px-3">add credit</a>
                                                                </div>
                                                                <div class="menu-item px-3">
                                                                    <a data-bs-toggle="modal" type="button" data-bs-target="#zero_user_withdraw_modal" class="menu-link px-3">commission withdrawal</a>
                                                                </div>
                                                            ...
                                                            <div class="col-7">
																<div class="d-flex flex-column content-justify-center flex-grow-1">
																	<div class="d-flex fs-6 fw-semibold align-items-center">
																		...
																		<div class="fs-6 fw-bolder text-gray-400 flex-shrink-0">credit</div>
																	...
																	<div class="d-flex fs-6 fw-semibold align-items-center my-1">
																		...
																		<div class="fs-6 fw-bolder text-gray-400 flex-shrink-0">commission</div>
																		<div class="separator separator-dashed min-w-10px flex-grow-1 mx-2"></div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                                                                <tbody class="fs-6 fw-semibold text-gray-600">
                                                                    ...
                                                                    <tr>
                                                                        <td>Telegram</td>
                                                                        <td>{if $user->telegram_id == null}unbound Telegram{else}{$user->telegram_id}{/if}</td>
                                                                        <td class="text-end">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="fw-bold">change email</h2>
                    </div>
        ...
        <div class="modal fade" id="zero_modal_user_update_password" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="fw-bold">change passwd</h2>
                    </div>
                    <div class="modal-body scrolly-y mx-5 mx-xl-15 my-7">
        ...
        <div class="modal fade" id="zero_user_withdraw_method_modal" tabindex="-1" data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">withdraw account</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <form>
                            <div class="mb-3">
                                <label class="col-form-label fw-bold" for="withdraw_account_value">account:</label>						
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="KTUsersWithdrawCommission(2)">submit</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="zero_user_withdraw_modal" tabindex="-1" data-bs-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">commission withdrawal</h4>
                    </div>
                    <div class="modal-body">
                        <label class="col-form-label fw-bolder" for="withdraw_commission_amount">amount:</label>
                        <form class="mb-3">
                            <input type="number" class="form-control" placeholder="amount" id="withdraw_commission_amount"/>
                        </form>
                        <span class="fw-bolder">withdrawal method:</span>
                        <ul class="nav nav-pills row nav-primary mb-3 mt-3" role="tablist" id="withdraw_type">
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="btn btn-outline btn-outline-dashed btn-active-light-primary text-start d-flex flex-grow-1 flex-column align-items-center active" data-bs-toggle="pill" data-type="1">
                                    ...
                                    <span class="nav-text fs-6 py-2 text-center">withdraw to credit<br/>
                                    <small>no less than: 0</small></span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="btn btn-outline btn-outline-dashed btn-active-light-primary text-start d-flex flex-grow-1 flex-column align-items-center" data-bs-toggle="pill" data-type="2">
                                    ...
                                    <span class="nav-text fs-6 py-2 text-center">withdraw to usdt<br />
                                    <small>no less than: {$config['withdraw_minimum_amount']}</small></span>
                                </a>
                            </li>
                            {/if}
                        </ul>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Hủy</button>
                        <button type="button" class="btn btn-primary" type="button" onclick="KTUsersWithdrawCommission(1)">submit</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="zero_user_add_credit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow-lg">
                    ...
                    <div class="modal-body">
                        <label class="col-form-label fw-bolder" for="add_credit_amount">amount:</label>		
                        <div class="form-group">
							<div class="input-group" data-kt-dialer="true" data-kt-dialer-min="1"data-kt-dialer-max="50000"data-kt-dialer-step="5">
								...
								<input type="text" class="form-control"  placeholder="amount" value="5" data-kt-dialer-control="input" id="add_credit_amount"/>
