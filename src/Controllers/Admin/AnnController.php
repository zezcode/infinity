            ...
            return [
                ...
                'action'     => <<<EOT
                                    <div class="btn-group dropstart"><a class="btn btn-light-primary btn-sm dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">Thao tác</a>
                                        ...
                                        <li><a class = "dropdown-item" type = "button" onclick = "zeroAdminUpdateNews('request', {$rowData->id})">Chỉnh sửa</a></li>
                                        <li><a class = "dropdown-item" type = "button" onclick = "zeroAdminDelete('news', {$rowData->id})">Xóa bỏ</a></li>
                                        </ul>
                                    </div>
                                EOT,
            ];
