  ...
  "object" == typeof exports && "undefined" != typeof module
    ...
    : ((e =
        "undefined" != typeof globalThis
          ? globalThis
          : e || self).i18nextBrowserLanguageDetector = o());
})(this, function () {
  "use strict";
  function e(e, o) {
    if (!(e instanceof o))
  ...
  var r = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
    ...
    u = function (e, o, t, n) {
      ...
      t &&
        ...
        n && (i.domain = n),
        (document.cookie = s(e, encodeURIComponent(o), i));
    },
    c = function (e) {
      for (
        var o = "".concat(e, "="), t = document.cookie.split(";"), n = 0;
        n < t.length;
        n++
      ) {
    ...
    d = {
      ...
      lookup: function (e) {
        ...
        if ("undefined" != typeof window) {
          ...
          for (var n = t.substring(1).split("&"), i = 0; i < n.length; i++) {
            var a = n[i].indexOf("=");
            if (a > 0)
