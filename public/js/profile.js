    ...
    var validator = FormValidation.formValidation(form, {
      fields: {
        profile_email: {
          validators: {
            notEmpty: {
              message: i18next.t("Địa chỉ Email là bắt buộc"),
            },
            emailAddress: {
              message: i18next.t("Email không hợp lệ"),
            },
          },
        },
      },
    ...
    var validator = FormValidation.formValidation(form, {
      fields: {
        current_password: {
          validators: {
            notEmpty: {
              message: i18next.t("Mật khẩu là bắt buộc"),
            },
          },
        },
        password: {
          validators: {
            ...
            callback: {
              message: i18next.t("Vui lòng nhập mật khẩu hợp lệ"),
        ...
        confirm_password: {
          validators: {
            notEmpty: {
              message: i18next.t("Xác nhận mật khẩu là bắt buộc"),
            },
            identical: {
              compare: function () {
                return form.querySelector('[name="new_password"]').value;
              },
              message: i18next.t("Hai lần nhập mật khẩu không giống nhau"),
            },
          },
        },
      },
