          ...
          },
          {
            ...
            value: function (t) {
              return new e(
                this.logger,
                p(
                  p({}, { prefix: "".concat(this.prefix, ":").concat(t, ":") }),
                  this.options
                )
              );
            },
  ...
  var F = (function (e) {
      ...
      function r(e) {
        ...
        return (
          ...
          void 0 === o.options.ignoreJSONStructure &&
          ...
          },
          {
            ...
            value: function (e, t, n) {
              ...
              return s || !i || "string" != typeof n
                ? s
                : D(this.data && this.data[e] && this.data[e][t], n, o);
            },
          },
          {
            key: "addResource",
            ...
            },
            {
              ...
              value: function (t, n, r) {
                ...
                if (
                  ...
                  (v = v.join(k)) && (v = this.extendTranslation(v, t, n, r));
                else {
                  var C = !1,
                    E = !1,
                  ...
                  !this.isValidLookup(v) && F && ((C = !0), (v = A)),
                    this.isValidLookup(v) || ((E = !0), (v = c));
                  var V =
                  ...
                  if (E || C || K) {
                    ...
                    if ("fallback" === this.options.saveMissingTo && H && H[0])
                      for (var z = 0; z < H.length; z++) M.push(H[z]);
                    else
                    ...
                    var J = function (e, t, r) {
                      ...
                      o.options.missingKeyHandler
                        ? o.options.missingKeyHandler(e, f, t, i, K, n)
                        : o.backendConnector &&
                          o.backendConnector.saveMissing &&
                          o.backendConnector.saveMissing(e, f, t, i, K, n),
                        o.emit("missingKey", e, f, t, v);
                    };
                  ...
                  (v = this.extendTranslation(v, t, n, d, r)),
                    E &&
                      v === c &&
              ...
              value: function (e, t, n, r, o) {
                ...
                if (this.i18nFormat && this.i18nFormat.parse)
                  e = this.i18nFormat.parse(
                    e,
                    T(T({}, this.options.interpolation.defaultVariables), n),
                    r.usedLng,
                    r.usedNS,
                    r.usedKey,
                    { resolved: r }
                  ...
                  if (
                    (this.options.interpolation.defaultVariables &&
                      (c = T(
                        T({}, this.options.interpolation.defaultVariables),
                        c
                      )),
                  ...
                  e.forEach(function (e) {
                    if (!a.isValidLookup(t)) {
                      ...
                      l.forEach(function (e) {
                        a.isValidLookup(t) ||
                          ((i = e),
                          !U["".concat(h[0], "-").concat(e)] &&
                            a.utils &&
                            a.utils.hasLoadedNamespace &&
                            !a.utils.hasLoadedNamespace(i) &&
                            ((U["".concat(h[0], "-").concat(e)] = !0),
                            a.logger.warn(
                              'key "'
              ...
              [
                ...
                for (a = 0; (o = t.regex.exec(e)); ) {
                  ...
                  if (void 0 === (i = l(n)))
                    ...
                    "string" == typeof i || s.useRawValueToEscape || (i = y(i));
                  var c = t.safeValue(i);
                  if (
                    ((e = e.replace(o[0], c)),
                    p
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            for (; (n = this.nestingRegexp.exec(e)); ) {
              var u = [];
              ((o =
                (o = Y({}, a)).replace && "string" != typeof o.replace
                  ? o.replace
                ...
                c &&
                  (r = u.reduce(function (e, t) {
                    return i.format(
                      ...
                      t,
                      a.lng,
                      Y(Y({}, a), {}, { interpolationkey: n[1].trim() })
                    );
                  }, r.trim())),
                (e = e.replace(n[0], r)),
          ...
          value: function (e, t, n) {
            var r = this,
              ...
              a = i.reduce(function (e, t) {
                ...
                return (
                  r.logger.warn("there was no format function for ".concat(a)),
                  e
                );
              }, e);
            return a;
  ...
  var se = (function (e) {
    ...
    function r(e, o, a) {
      ...
      return (
        ...
        (s.options = u),
        (s.logger = h.create("backendConnector")),
        (s.waitingReads = []),
          ...
          value: function (e, t, n, r, o) {
            ...
            if (
              ...
              if (this.backend && this.backend.create) {
                var s = ie(ie({}, i), {}, { isUpdate: o }),
                  u = this.backend.create.bind(this.backend);
                if (u.length < 6)
                  try {
                    var c;
                    (c = 5 === u.length ? u(e, t, n, r, s) : u(e, t, n, r)) &&
      ...
      o(a, [
        {
          ...
          value: function () {
            ...
            if (
              ((this.options = fe(fe(fe({}, r), this.options), ce(t))),
              "v1" !== this.options.compatibilityAPI &&
                (this.options.interpolation = fe(
                  fe({}, r.interpolation),
                  this.options.interpolation
                )),
              void 0 !== t.keySeparator &&
            ...
            var o = this,
              i = function t(n, i) {
                ...
                (a.lng = a.lng || t.lng),
                  ...
                  (a.ns = a.ns || t.ns),
                  (a.keyPrefix = a.keyPrefix || r || t.keyPrefix);
                var l,
                  f = o.options.keySeparator || ".";
                return (
                  (l =
                    a.keyPrefix && Array.isArray(n)
                      ? n.map(function (e) {
                          return "".concat(a.keyPrefix).concat(f).concat(e);
                        })
                      : a.keyPrefix
                      ? "".concat(a.keyPrefix).concat(f).concat(n)
                      : n),
                  o.t(l, a)
                );
              };
        ...
        },
        {
          ...
          value: function (e) {
            if (
              ...
              return "rtl";
            var t =
              (this.services && this.services.languageUtils) || new M(ue());
            return [
              "ar",
              "shu",
              "sqr",
            ...
            var e = this,
              ...
              n =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : ge,
              r = fe(fe(fe({}, this.options), t), { isClone: !0 }),
              o = new a(r);
